...
**ZEngine** is a social ecology simulator and party-based roguelike. It focuses on procedural generation, narrative persistence, and a reactive social layer. The project is currently in **Phase 25 (Game-Over Flow)** (Checkpoint v0.46), focusing on terminal states and player death recovery.
