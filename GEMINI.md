...
**ZEngine** is a social ecology simulator and party-based roguelike. It focuses on procedural generation, narrative persistence, and a reactive social layer. The project is currently entering **Phase 25 (Game-Over Flow)** (Checkpoint v0.45), following the completion of Phase 24 (Narrative UI). The active horizon spans Phases 25 through 32 (Content Volume), aiming to fulfill core gameplay loops, progression, quests, and expanded content.
