...
Spontaneous feature ideas and deferred systems reside in `FUTURE.md` until their prerequisite systems are built, at which point they migrate to `STATE_OF_THE_PROJECT.md`'s Active Horizon roadmap.
