...
**ZEngine** is a social ecology simulator and party-based roguelike. It focuses on procedural generation, narrative persistence, and a reactive social layer. The project is currently actively developing **Phase 25 (Game-Over Flow)** (Checkpoint v0.45), following the completion of Phase 24 (Narrative UI).
