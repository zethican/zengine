...
**ZEngine** is a social ecology simulator and party-based roguelike. It focuses on procedural generation, narrative persistence, and a reactive social layer. The project is currently entering **Phase 25 (Ability Effect Resolver Wiring)** (Checkpoint v0.45), following the completion of Phase 24 (Narrative UI).
