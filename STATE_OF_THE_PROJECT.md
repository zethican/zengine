...
| ----------------------- | ----------------------- | ------------------------------------------------------------ |
| **Current Phase**       | 25 (Game-Over Flow)     | Terminal game states and player death recovery implementation|
...
### Phase 25: Game-Over / Restart Flow (Active) (Blocking: Playtestability)
