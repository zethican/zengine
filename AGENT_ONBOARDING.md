...
Exit criteria: `GameState` enum terminal values created and integrated for recoverable player death.
...
- Exit criteria: `tcod.path.AStar` integrated in `ai_system.py`
