...
* **Phase 25: Game-Over Flow** — **(ACTIVE)** Terminal states and player death recovery.
...
* **Phase 32: Wilderness / Biome Depth** — Per-biome spawn tables, noise-blended seams, and dynamic weather.
