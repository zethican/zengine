...
* **v0.46 (Phase 25) - Active**
  * **Game-Over Flow:** Terminal states and player death recovery.
  * **Wilderness / Biome Depth:** Biome data definitions and Encounter density driver.
