...
### 1. AI Multi-Tile Pathfinding (Blocking: Navigation)
...
### 2. Player Progression (Blocking: Core RPG Arc)
...
### 3. Status Effect HUD (Blocking: Gameplay Feel)
...
### 4. Quest / Objective System (Blocking: RPG Layer)
