...
-------------------------------------------------------------
  AP_POOL_SIZE            TBD Phase 1  — register in DESIGN_VARIABLES.md
  MOVEMENT_ALLOCATION     TBD Phase 1  — speed-derived; register before Phase 2
...
----------------------------------------
  [ ] EventPayload.data: typed dicts per event (Phase 1 hardening task)
  [ ] AP pool size and movement allocation: register before Phase 2
  [ ] Social Layer catch-up tick count at session boundary: register before Phase 1
"""
...
# AP and Movement are TBD — registered here as sentinels so agents
# log them rather than silently hardcode.
AP_POOL_SIZE: Optional[int] = None          # REGISTER BEFORE PHASE 2
MOVEMENT_ALLOCATION: Optional[float] = None # REGISTER BEFORE PHASE 2
